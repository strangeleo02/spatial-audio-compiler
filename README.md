...
- 🧠 **C++ Binaural Engine** — high-performance 3D spatialization using pybind11:
  - **ITD** (Inter-aural Time Delay) using Woodworth's spherical head delay formula.
  - **ILD** (Inter-aural Level Difference) high-shelf biquad filtering to model head shadowing.
  - **Pinna elevation** cues using an 8kHz high-shelf filter.
  - **Distance** model using $1/d$ volume drop-off and distance-dependent air absorption (low-pass filtering).
  - **Rear Hemisphere** high-frequency cut for sounds positioned behind the listener.
...
- 💾 **Mix & Export** — render your 3D spatial binaural mix offline into a stereo WAV file.
